...
namespace DiamondProject.Migrations
{
    ...
    [Migration("20240228142000_AddRingBrandTable")]
    partial class AddRingBrandTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiamondProject.Models.Model.Brand", b =>
                {
            ...
            modelBuilder.Entity("DiamondProject.Models.Model.RingBrand", b =>
                {
                    b.Property<Guid>("RingBrandId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("RingBrandId");

                    b.HasIndex("BrandId");

                    b.ToTable("RingBrands", (string)null);
                });

            modelBuilder.Entity("DiamondProject.Models.Model.RingBrandImage", b =>
                {
                    b.Property<Guid>("RingBrandImageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasKey("RingBrandImageId");

                    b.HasIndex("RingBrandId");

                    b.ToTable("RingBrandImages", (string)null);
                });
            ...
            modelBuilder.Entity("DiamondProject.Models.Model.RingBrand", b =>
                {
                    b.HasOne("DiamondProject.Models.Model.Brand", "Brand")
                        .WithMany("RingBrands")
            ...
            modelBuilder.Entity("DiamondProject.Models.Model.RingBrandImage", b =>
                {
                    b.HasOne("DiamondProject.Models.Model.RingBrand", "RingBrand")
                        .WithMany("RingBrandImages")
                        .HasForeignKey("RingBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RingBrand");
                });

            modelBuilder.Entity("DiamondProject.Models.Model.Brand", b =>
                {
                    b.Navigation("RingBrands");
                });
